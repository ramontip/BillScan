...
<head>
    <head:meta-main/>
    <title>BillScan • <spring:message code="expenses.header"/></title>
</head>
...
<div class="w-100">
    ...
    <body:navbar/>
    <body:header activePage="expenses"/>
                        ...
                        <div class="col">
                            <div class="card bs-box-shadow h-100 w-100">
                                <div class="card-title pt-3 px-3 mb-0">
                                    <div class="h5"><spring:message code="expenses.household"/></div>
                                </div>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped align-middle">
                                            <thead>
                                            <tr>
                                                <th scope="col"><spring:message code="household.title"/></th>
                                            ...
                                            <c:if test="${not empty bills}">
                                                ...
                                                <c:forEach var="bill" items="${bills}">
                                                    ...
                                                    <tr>
                                                        <td><a
                                                                href="/household/${bill.household.id}/show"><c:out
                                                                value="${bill.household.title}"/></a></td>
                                                        ...
                                                        <td class="text-end">
                                                            <c:if test="${not empty bill.files}">
                                                                <a href="/household/${bill.household.id}/bill/${bill.id}/show/file">
